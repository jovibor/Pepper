...
int CViewRightTL::CreateListDOSHeader()
{
	...
	m_stlcs.dwStyle = 0;
	m_stlcs.nID = IDC_LIST_DOSHEADER;
...
int CViewRightTL::CreateListRichHeader()
{
	...
	m_stlcs.dwStyle = 0;
	m_stlcs.nID = IDC_LIST_RICHHEADER;
...
int CViewRightTL::CreateListFileHeader()
{
	...
	m_stlcs.dwStyle = 0;
	m_stlcs.nID = IDC_LIST_FILEHEADER;
...
int CViewRightTL::CreateListOptHeader()
{
	...
	m_stlcs.dwStyle = 0;
	m_stlcs.nID = IDC_LIST_OPTIONALHEADER;
...
int CViewRightTL::CreateListDataDirectories()
{
	...
	m_stlcs.dwStyle = 0;
	m_stlcs.nID = IDC_LIST_DATADIRECTORIES;
...
int CViewRightTL::CreateListSecHeaders()
{
	...
	m_stlcs.nID = IDC_LIST_SECHEADERS;
...
int CViewRightTL::CreateListExceptions()
{
	...
	m_stlcs.dwStyle = LVS_OWNERDATA;
	m_stlcs.nID = IDC_LIST_EXCEPTION;
...
int CViewRightTL::CreateListRelocations()
{
	...
	m_stlcs.dwStyle = LVS_OWNERDATA;
	m_stlcs.nID = IDC_LIST_RELOCATIONS;
...
int CViewRightTL::CreateListLCD()
{
	...
	m_stlcs.dwStyle = 0;
	m_stlcs.nID = IDC_LIST_LOADCONFIG;
...
int CViewRightTL::CreateListBoundImport()
{
	...
	m_stlcs.dwStyle = 0;
	m_stlcs.nID = IDC_LIST_DELAYIMPORT;
