...
constexpr auto IDC_LIST_SECHEADERS_ENTRY = 0x0008;
constexpr auto IDC_LIST_EXPORT = 0x0009;
constexpr auto IDC_LIST_EXPORT_FUNCS = 0x000A;
constexpr auto IDC_LIST_IMPORT = 0x000B;
constexpr auto IDC_LIST_IMPORT_ENTRY = 0x000C;
constexpr auto IDC_LIST_EXCEPTION = 0x000D;
constexpr auto IDC_LIST_SECURITY = 0x000E;
constexpr auto IDC_LIST_SECURITY_ENTRY = 0x000F;
constexpr auto IDC_LIST_RELOCATIONS = 0x0010;
constexpr auto IDC_LIST_RELOCATIONS_ENTRY = 0x0011;
constexpr auto IDC_LIST_DEBUG = 0x0012;
constexpr auto IDC_LIST_DEBUG_ENTRY = 0x0013;
constexpr auto IDC_LIST_ARCHITECTURE = 0x0014;
constexpr auto IDC_LIST_GLOBALPTR = 0x0015;
constexpr auto IDC_LIST_TLS = 0x0016;
constexpr auto IDC_LIST_TLS_CALLBACKS = 0x0017;
constexpr auto IDC_LIST_LOADCONFIG = 0x0018;
constexpr auto IDC_LIST_BOUNDIMPORT = 0x0019;
constexpr auto IDC_LIST_IAT = 0x001A;
constexpr auto IDC_LIST_DELAYIMPORT = 0x001B;
constexpr auto IDC_LIST_DELAYIMPORT_FUNCS = 0x001C;
constexpr auto IDC_LIST_COMDESCRIPTOR = 0x001D;
