...
#ifdef _WIN64
#define PEPPER_VERSION_WSTR TOWSTR(PRODUCT_NAME) ", v" STR(MAJOR_VERSION) "." STR(MINOR_VERSION) "." STR(MAINTENANCE_VERSION) " (x64)"
#else
#define PEPPER_VERSION_WSTR TOWSTR(PRODUCT_NAME) ", v" STR(MAJOR_VERSION) "." STR(MINOR_VERSION) "." STR(MAINTENANCE_VERSION)
#endif
